...
function(GenerateSimulateScript)
    ...
    elseif(KernelPlatformSpike)
        ...
        set(QemuBinaryMachine "${binary} -machine spike_v1.10 -m size=4095M")
        list(APPEND QemuFlags "-s -serial mon:stdio")
        set(QemuMemSize "4095M")
    else()
