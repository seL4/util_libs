...
function(GenerateSimulateScript)
    ...
    set(graphic "$<IF:$<BOOL:$<TARGET_PROPERTY:simulation_script_prop_target,GRAPHIC>>,,-nographic>")
    if(KernelArchX86)
        ...
        set(script "qemu-system-x86_64 -cpu ${sim_cpu} -m 512 ${graphic} -serial mon:stdio -kernel ${KERNEL_IMAGE_NAME} -initrd ${IMAGE_NAME}")
    elseif(KernelPlatformKZM)
        set(script "qemu-system-arm ${graphic} -M kzm -kernel ${IMAGE_NAME}")
    elseif(KernelPlatformSabre)
        set(script "qemu-system-arm -machine sabrelite ${graphic} -m size=1024M -s -serial null -serial mon:stdio -kernel ${IMAGE_NAME}")
