...
static int keyboard_getchar(struct ps_chardevice *device)
{
...
static ssize_t keyboard_write(ps_chardevice_t *d, const void *vdata, size_t count, chardev_callback_t rcb UNUSED,
                              void *token UNUSED)
{
...
static ssize_t keyboard_read(ps_chardevice_t *d, void *vdata, size_t count, chardev_callback_t rcb UNUSED,
                             void *token UNUSED)
{
    int ret;
    int i;
...
static void keyboard_handle_irq(ps_chardevice_t *device UNUSED)
{
    /* No IRQ handling required here. */
}

int keyboard_cdev_init(const struct dev_defn *defn, const ps_io_ops_t *ops, ps_chardevice_t *dev)
{
