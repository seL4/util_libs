 ...
 *
 * These structures directly coorelate to the registers and data structures found
 * in the Serial ATA AHCI 1.3.1 specification document found here:
...
// HBA = Host Bus Adapter, refers to the device that implements the ahci spec
