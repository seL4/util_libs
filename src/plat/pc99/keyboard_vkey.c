...
keycode_vkey_desc(uint16_t vk)
{
    switch (vk) {
        ...
        case VK_0: return "VK_0";
        case VK_1: return "VK_1";
        case VK_2: return "VK_2";
        case VK_3: return "VK_3";
        case VK_4: return "VK_4";
        case VK_5: return "VK_5";
        case VK_6: return "VK_6";
        case VK_7: return "VK_7";
        case VK_8: return "VK_8";
        case VK_9: return "VK_9";
        case VK_A: return "VK_A";
        case VK_B: return "VK_B";
        case VK_C: return "VK_C";
        case VK_D: return "VK_D";
        case VK_E: return "VK_E";
        case VK_F: return "VK_F";
        case VK_G: return "VK_G";
        case VK_H: return "VK_H";
        case VK_I: return "VK_I";
        case VK_J: return "VK_J";
        case VK_K: return "VK_K";
        case VK_L: return "VK_L";
        case VK_M: return "VK_M";
        case VK_N: return "VK_N";
        case VK_O: return "VK_O";
        case VK_P: return "VK_P";
        case VK_Q: return "VK_Q";
        case VK_R: return "VK_R";
        case VK_S: return "VK_S";
        case VK_T: return "VK_T";
        case VK_U: return "VK_U";
        case VK_V: return "VK_V";
        case VK_W: return "VK_W";
        case VK_X: return "VK_X";
        case VK_Y: return "VK_Y";
        case VK_Z: return "VK_Z";
...
keycode_ps2_to_vkey(int32_t ps2_keycode)
{
    ...
    switch (ps2_keycode) {
        case PS2_KEY_PRTSCR: return VK_SNAPSHOT;
        case PS2_KEY_PAUSE: return VK_PAUSE;
        case PS2_KEY_WINDOWS_LEFT: return VK_LEFT;
        case PS2_KEY_ALT_RIGHT: return VK_MENU;
        case PS2_KEY_WINDOWS_RIGHT: return VK_RIGHT;
        case PS2_KEY_MENUS: return VK_MENU;
        case PS2_KEY_INSERT: return VK_INSERT;
        case PS2_KEY_HOME: return VK_HOME;
        case PS2_KEY_PAGE_UP: return VK_PRIOR;
        case PS2_KEY_DELETE: return VK_DELETE;
        case PS2_KEY_END: return VK_END;
        case PS2_KEY_PAGE_DOWN: return VK_NEXT;
        case PS2_KEY_UP_ARROW: return VK_UP;
        case PS2_KEY_LEFT_ARROW: return VK_LEFT;
        case PS2_KEY_DOWN_ARROW: return VK_DOWN;
        case PS2_KEY_RIGHT_ARROW: return VK_RIGHT;
        case PS2_KEY_NUM_DIVIDE: return VK_DIVIDE;
        case PS2_KEY_NUM_ENTER: return VK_RETURN;
    }
    return -1;
}
